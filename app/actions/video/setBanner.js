...
export default async function setBanner(data) {
  try {
    ...
    let image1 = ayar?.banner?.banner1?.image || null;
    ...
    let image2 = ayar?.banner?.banner2?.image || null;
    ...
    let image3 = ayar?.banner?.banner3?.image || null;
    ...
    let image4 = ayar?.banner?.banner4?.image || null;
    ...
    let image5 = ayar?.banner?.banner5?.image || null;
    ...
    let image6 = ayar?.banner?.banner6?.image || null;
    ...
    let image7 = ayar?.banner?.banner7?.image || null;
    ...
    let image8 = ayar?.banner?.banner8?.image || null;
