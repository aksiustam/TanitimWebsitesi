...
import setMBanner from "@/app/actions/video/setMBanner";
import Image from "next/image";
import Accordion from "react-bootstrap/Accordion";
import "bootstrap/dist/css/bootstrap.min.css";
import "./style.css";
const BannerMTR = (props) => {
  const bannerData = props.ayarlar?.mbanner;
  ...
  const onSubmit = async (data) => {
    ...
    const res = await setMBanner(formData);
    if (res === true) {
      await Swal.fire({
        icon: "success",
