...
import setMBannerEn from "@/app/actions/video/setMBannerEn";
import Image from "next/image";
import Accordion from "react-bootstrap/Accordion";
import "bootstrap/dist/css/bootstrap.min.css";
import "./style.css";
const BannerMEN = (props) => {
  const bannerData = props.ayarlar?.mbanneren;
  ...
  const onSubmit = async (data) => {
    ...
    const res = await setMBannerEn(formData);
    if (res === true) {
      await Swal.fire({
        icon: "success",
